...
{
    public class ContentDisplayBase
    {
        /// <summary>
        ...
        public virtual Task<DisplayResult> UpdateEditorAsync(UpdateEditorContext context, IUpdateModel updater)
        {
        ...
        public virtual DisplayResult UpdateEditor(UpdateEditorContext context, IUpdateModel updater)
        {
            return null;
        }
    }
