...
namespace OrchardCore.AuditTrail.Services.Models
{
    public class AuditTrailCategoryDescriptor
    {
        ...
        private static readonly IReadOnlyDictionary<string, AuditTrailEventDescriptor> _empty = new Dictionary<string, AuditTrailEventDescriptor>();

        public static AuditTrailCategoryDescriptor Default(string name) => new(name, (sp) => new LocalizedString(name, name), _empty);
    }
}
