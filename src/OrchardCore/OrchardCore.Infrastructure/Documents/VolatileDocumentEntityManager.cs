namespace OrchardCore.Documents
{
    ...
    /// </summary>
    public class VolatileDocumentEntityManager<TDocumentEntity> : DocumentEntityManager<TDocumentEntity>, IVolatileDocumentEntityManager<TDocumentEntity>
        where TDocumentEntity : class, IDocumentEntity, new()
    {
