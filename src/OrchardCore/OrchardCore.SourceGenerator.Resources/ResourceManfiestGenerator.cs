...
namespace OrchardCore.ResourceManagement
{
    ...
    {
        const string cloudflareUrl = ""https://cdnjs.cloudflare.com/ajax/libs/"";
        // Versions
        const string codeMirrorVersion = ""5.63.3"";
        const string monacoEditorVersion = ""0.29.1"";
        // URLs
        const string codeMirrorUrl = cloudflareUrl + ""codemirror/"" + codeMirrorVersion + ""/"";
