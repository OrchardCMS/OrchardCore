...
public class SmtpResult : EmailResult
{
    ...
    /// </summary>
    [Obsolete("This class should no longer be used. Instead use SmtpResult.SuccessResult instead.")]
    ...
    [Obsolete("This class should no longer be used. Instead use SmtpResult.FailedResult instead.")]
