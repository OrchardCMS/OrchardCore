...
namespace OrchardCore.Media
{
    ...
    {
        /// <summary>
        /// Maps a relative path within the file store to a publicly accessible URL.
        /// </summary>
        ...
        /// <summary>
        /// Maps a public URL to a relative path within the file store.
        /// </summary>
        /// <param name="publicUrl">The public URL to map.</param>
        /// <returns>The mapped relative path of the given public URL within the file store.</returns>
