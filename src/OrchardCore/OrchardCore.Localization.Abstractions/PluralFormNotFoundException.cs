...
namespace OrchardCore.Localization
{
    ...
    public class PluralFormNotFoundException : Exception
    {
        ...
        public PluralFormNotFoundException(string message)
            : base(message) { }
        ...
        public PluralFormNotFoundException(string message, PluralForm form)
            : base(message)
        {
            Form = form;
        }
        ...
        public PluralFormNotFoundException(string message, Exception innerException)
