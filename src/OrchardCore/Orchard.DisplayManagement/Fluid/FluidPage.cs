...
namespace Orchard.DisplayManagement.Fluid
{
    public class FluidPage : Razor.RazorPage<dynamic>
    {
        ...
        {
            await RenderFluidViewAsync(this);
        }

        internal static async Task RenderFluidViewAsync(FluidPage page)
        {
            ...
            var template = ParseFluidViewFile(path, environment.ContentRootFileProvider);
        ...
        internal static IFluidTemplate ParseFluidViewFile(string path, IFileProvider fileProvider)
        {
