...
public static class ShellStringExtensions
{
    ...
    /// </summary>
    public static bool IsDefaultShellNameIgnoreCase(this string name) => name is not null && name.Equals(ShellSettings.DefaultShellName, StringComparison.OrdinalIgnoreCase);
}
