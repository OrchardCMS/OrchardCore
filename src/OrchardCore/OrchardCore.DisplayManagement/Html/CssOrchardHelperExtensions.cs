...
public static class CssOrchardHelperExtensions
{
    ...
    public static IHtmlContent GetEndClasses(this IOrchardHelper helper, bool withOffset, params string[] additionalClasses)
    {
        ...
        {
            var cssClasses = new List<string>(additionalClasses) { options.OffsetClasses };
    ...
    public static TheAdminThemeOptions GetThemeOptions(this IOrchardHelper helper) => helper.HttpContext.RequestServices.GetService<IOptions<TheAdminThemeOptions>>().Value;
