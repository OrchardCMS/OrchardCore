...
namespace OrchardCore.DisplayManagement.Notify
{
    public static class NotifierExtensions
    {
        ...
        /// <param name="notifier">The <see cref="INotifier"/>.</param>
        /// <param name="message">A localized message to display.</param>
        public static ValueTask WarningAsync(this INotifier notifier, LocalizedHtmlString message) => notifier.AddAsync(NotifyType.Warning, message);
        ...
        /// <param name="notifier">The <see cref="INotifier"/>.</param>
        /// <param name="message">A localized message to display.</param>
        public static ValueTask ErrorAsync(this INotifier notifier, LocalizedHtmlString message) => notifier.AddAsync(NotifyType.Error, message);
        ...
        /// <param name="notifier">The <see cref="INotifier"/>.</param>
        /// <param name="message">A localized message to display.</param>
        public static ValueTask SuccessAsync(this INotifier notifier, LocalizedHtmlString message) => notifier.AddAsync(NotifyType.Success, message);
    }
}
