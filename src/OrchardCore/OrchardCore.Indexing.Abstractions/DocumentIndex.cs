...
namespace OrchardCore.Indexing
{
    public class DocumentIndex
    {
        ...
        public List<IDocumentIndexEntry> Entries { get; } = new List<IDocumentIndexEntry>();
        ...
        public interface IDocumentIndexEntry
        {
            string Name { get; }
            object Value { get; }
            Types Type { get; }
            DocumentIndexOptions Options { get; }
        }

        private class DocumentIndexEntry : IDocumentIndexEntry
        {
