...
namespace OrchardCore.FileStorage
{
    ...
    /// file store. Absolute paths using a leading slash are not supported.
    /// </remarks>
    public interface IFileStore
    {
        ...
        /// </summary>
        /// <param name="path">The relative path of the directory to enumerate, or <c>null</c> to enumerate the root of the file store.</param>
        ...
        /// </summary>
        /// <param name="path">The relative path of the directory to be created.</param>
        ...
        /// </summary>
        /// <param name="path">The relative path of the file to be deleted.</param>
        ...
        /// </summary>
        /// <param name="path">The relative path of the directory to be deleted.</param>
        ...
        /// </summary>
        /// <param name="oldPath">The relative path of the file to be renamed/moved.</param>
        /// <param name="newPath">The new relative path of the file after the rename/move.</param>
        ...
        /// </summary>
        /// <param name="oldPath">The relative path of the directory to be renamed/moved.</param>
        /// <param name="newPath">The new relative path of the directory after the rename/move.</param>
        /// <exception cref="FileStoreException">Thrown if the specified directory does not exist.</exception>
        ...
        /// </summary>
        /// <param name="srcPath">The relative path of the source file to be copied.</param>
        /// <param name="dstPath">The relative path of the destination file to be created.</param>
        ...
        /// </summary>
        /// <param name="path">The relative path of the file to be read.</param>
        ...
        /// </summary>
        /// <param name="path">The relative path of the file to be created.</param>
