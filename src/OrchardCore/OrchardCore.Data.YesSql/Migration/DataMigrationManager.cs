...
namespace OrchardCore.Data.Migration
{
    ...
    public class DataMigrationManager : IDataMigrationManager
    {
        ...
        public async Task<IEnumerable<string>> GetFeaturesThatNeedUpdateAsync()
        {
            ...
            return outOfDateMigrations.Select(m => _typeFeatureProvider.GetFeaturesForDependency(m.GetType()).Id).ToArray();
        }
        ...
        private IDataMigration[] GetDataMigrations(string featureId)
        {
            var migrations = _dataMigrations
                    .Where(dm => _typeFeatureProvider.GetFeaturesForDependency(dm.GetType()).Id == featureId)
                    .ToArray();
