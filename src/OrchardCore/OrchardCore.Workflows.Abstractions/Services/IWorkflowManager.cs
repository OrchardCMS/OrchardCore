...
namespace OrchardCore.Workflows.Services
{
    public interface IWorkflowManager
    {
        ...
        /// </summary>
        Workflow NewWorkflowInstance(WorkflowType workflowDefinitionRecord, string correlationId = null);

        /// <summary>
        /// Creates a new <see cref="WorkflowExecutionContext"/>.
        /// </summary>
        Task<WorkflowExecutionContext> CreateWorkflowExecutionContextAsync(WorkflowType workflowDefinition, Workflow workflowInstanceRecord, IDictionary<string, object> input = null);
        ...
        Task<WorkflowExecutionContext> StartWorkflowAsync(WorkflowType workflowDefinition, ActivityRecord startActivity = null, IDictionary<string, object> input = null, string correlationId = null);

        /// <summary>
        /// Resumes the specified workflow instance at the specified activity.
        /// </summary>
        Task<WorkflowExecutionContext> ResumeWorkflowAsync(Workflow workflowInstance, BlockingActivity awaitingActivity, IDictionary<string, object> input = null);
