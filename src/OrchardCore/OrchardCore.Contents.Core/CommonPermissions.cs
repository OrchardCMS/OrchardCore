...
namespace OrchardCore.Contents
{
    ...
    public class CommonPermissions
    {
        ...
        public static readonly Permission ListContent = new("ListContent", "List content item(s) owned by all users");
        public static readonly Permission ListOwnContent = new("ListOwnContent", "List own content item(s)", new[] { ListContent });
        ...
        static CommonPermissions()
        {
            ...
            OwnerPermissionsByName["ListContent"] = ListOwnContent;
        }
    }
}
