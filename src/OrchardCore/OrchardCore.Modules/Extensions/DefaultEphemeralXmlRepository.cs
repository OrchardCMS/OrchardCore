...
namespace OrchardCore.Modules.DataProtection.Repositories
{
    /// <summary>
    ...
    /// </summary>
    internal class DefaultEphemeralXmlRepository : IXmlRepository
    {
        private readonly List<XElement> _storedElements = new List<XElement>();

        public DefaultEphemeralXmlRepository(ILoggerFactory loggerFactory)
        {
            var logger = loggerFactory.CreateLogger<DefaultEphemeralXmlRepository>();
