...
/// <summary>
/// Optional interface for handling content type lifecycle events.
/// Can be implemented alongside IContentDefinitionHandler for unified event handling.
/// </summary>
public interface IContentTypeEventHandler
{
...
/// <summary>
/// Optional interface for handling content part lifecycle events.
/// Can be implemented alongside IContentDefinitionHandler for unified event handling.
/// </summary>
public interface IContentPartEventHandler
{
...
/// <summary>
/// Optional interface for handling content type part and field lifecycle events.
/// Can be implemented alongside IContentDefinitionHandler for unified event handling.
/// </summary>
public interface IContentFieldEventHandler
{
