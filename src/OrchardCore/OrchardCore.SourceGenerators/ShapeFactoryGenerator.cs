...
public class ShapeFactoryGenerator : IIncrementalGenerator
{
    ...
    {
        if (logicalParameters.IsDefault)
        {
            return null;
        }

        if (logicalParameters.Length == 0)
        {
    ...
    private static void Execute(ImmutableArray<InvocationInfo> invocations, SourceProductionContext context)
    {
        ...
        var needsAwaitedHelper = validInvocations.Any(static invocation => invocation.Kind is InvocationKind.FuncWithoutShapeType or InvocationKind.FuncWithShapeType or InvocationKind.FuncWithState);
    ...
    private static void GenerateShapeType(StringBuilder sb, INamedTypeSymbol modelType)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("        private global::System.Collections.Generic.List<string>? _classes;");
        sb.AppendLine();
        sb.AppendLine("        private global::System.Collections.Generic.Dictionary<string, string>? _attributes;");
        sb.AppendLine();
        sb.AppendLine("        private global::System.Collections.Generic.Dictionary<string, object>? _properties;");
        sb.AppendLine();
        sb.AppendLine("        private bool _sorted;");
        sb.AppendLine();
        sb.AppendLine("        private global::System.Collections.Generic.List<global::OrchardCore.DisplayManagement.IPositioned>? _items;");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "Metadata")}global::OrchardCore.DisplayManagement.Shapes.ShapeMetadata Metadata => _metadata ??= new global::OrchardCore.DisplayManagement.Shapes.ShapeMetadata();");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "Position")}string Position");
        sb.AppendLine("        {");
        sb.AppendLine("            get => Metadata.Position;");
        sb.AppendLine("            set => Metadata.Position = value;");
        sb.AppendLine("        }");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "Id")}string Id {{ get; set; }} = null!;");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "TagName")}string TagName {{ get; set; }} = null!;");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "Classes")}global::System.Collections.Generic.IList<string> Classes => _classes ??= [];");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "Attributes")}global::System.Collections.Generic.IDictionary<string, string> Attributes => _attributes ??= [];");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "Properties")}global::System.Collections.Generic.IDictionary<string, object> Properties => _properties ??= [];");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "Items")}global::System.Collections.Generic.IReadOnlyList<global::OrchardCore.DisplayManagement.IPositioned> Items");
        sb.AppendLine("        {");
        sb.AppendLine("            get");
        sb.AppendLine("            {");
        ...
        sb.AppendLine("            {");
        sb.AppendLine("                return global::System.Threading.Tasks.ValueTask.FromResult<global::OrchardCore.DisplayManagement.IShape>(this);");
        sb.AppendLine("            }");
        sb.AppendLine();
        sb.AppendLine("            position ??= string.Empty;");
        sb.AppendLine("            _sorted = false;");
        sb.AppendLine("            _items ??= [];");
        sb.AppendLine();
        sb.AppendLine("            var wrapped = global::OrchardCore.DisplayManagement.PositionWrapper.TryWrap(item, position);");
        sb.AppendLine("            if (wrapped is not null)");
        sb.AppendLine("            {");
        sb.AppendLine("                _items.Add(wrapped);");
        sb.AppendLine("            }");
        sb.AppendLine();
        sb.AppendLine("            return global::System.Threading.Tasks.ValueTask.FromResult<global::OrchardCore.DisplayManagement.IShape>(this);");
        sb.AppendLine("        }");
    ...
    private static void GenerateInterceptor(StringBuilder sb, InvocationInfo invocation)
    {
        ...
        {
            case InvocationKind.DisplayDriverWithoutShapeType:
                sb.AppendLine("        public static global::OrchardCore.DisplayManagement.Views.ShapeResult InterceptInitialize(this global::OrchardCore.DisplayManagement.Handlers.DisplayDriverBase driver)");
            ...
            case InvocationKind.DisplayDriverWithoutInitialize:
                sb.AppendLine("        public static global::OrchardCore.DisplayManagement.Views.ShapeResult InterceptInitialize(this global::OrchardCore.DisplayManagement.Handlers.DisplayDriverBase driver, string shapeType)");
    ...
    {
        DisplayDriverWithoutShapeType,
        DisplayDriverWithoutInitialize,
