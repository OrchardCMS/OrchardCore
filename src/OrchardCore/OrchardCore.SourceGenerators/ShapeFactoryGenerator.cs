...
public class ShapeFactoryGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateShapeType(StringBuilder sb, INamedTypeSymbol modelType)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("        private string? _id;");
        sb.AppendLine();
        sb.AppendLine("        private string? _tagName;");
        sb.AppendLine();
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            get => _id!;");
        sb.AppendLine("            set => _id = value;");
        sb.AppendLine("        }");
        sb.AppendLine();
        sb.AppendLine($"        public {GetMemberHidingModifier(modelType, "TagName")}string TagName");
        sb.AppendLine("        {");
        sb.AppendLine("            get => _tagName!;");
        sb.AppendLine("            set => _tagName = value;");
        sb.AppendLine("        }");
        sb.AppendLine();
