...
{
    public class BackgroundJobFilterEngineModelBinder : IModelBinder
    {
        private readonly IBackgroundJobsAdminListFilterParser _parser;

        public BackgroundJobFilterEngineModelBinder(IBackgroundJobsAdminListFilterParser parser)
        {
            _parser = parser;
        }
