...
namespace OrchardCore.ContentManagement.Records
{
    public class Migrations : DataMigration
    {
        ...
        {
            await SchemaBuilder.CreateMapIndexTableAsync<ContentItemIndex>(table =>
                table
            ...
            await SchemaBuilder.AlterIndexTableAsync<ContentItemIndex>(table =>
                table.CreateIndex("IDX_ContentItemIndex_DocumentId", "DocumentId", "ContentItemId", "ContentItemVersionId", "Published", "Latest")
            );

            await SchemaBuilder.AlterIndexTableAsync<ContentItemIndex>(table =>
                table.CreateIndex("IDX_ContentItemIndex_DocumentId_ContentType", "DocumentId", "ContentType", "CreatedUtc", "ModifiedUtc", "PublishedUtc", "Published", "Latest")
            );

            await SchemaBuilder.AlterIndexTableAsync<ContentItemIndex>(table =>
                table.CreateIndex("IDX_ContentItemIndex_DocumentId_Owner", "DocumentId", "Owner", "Published", "Latest")
            );

            await SchemaBuilder.AlterIndexTableAsync<ContentItemIndex>(table =>
                table.CreateIndex("IDX_ContentItemIndex_DocumentId_Author", "DocumentId", "Author", "Published", "Latest")
            );

            await SchemaBuilder.AlterIndexTableAsync<ContentItemIndex>(table =>
                table.CreateIndex("IDX_ContentItemIndex_DocumentId_DisplayText", "DocumentId", "DisplayText", "Published", "Latest")
            );
        ...
        {
            await SchemaBuilder.AlterIndexTableAsync<ContentItemIndex>(table => table.AddColumn<string>("ContentItemVersionId", c => c.WithLength(26)));
        ...
        {
            await SchemaBuilder.AlterIndexTableAsync<ContentItemIndex>(table =>
                table.AddColumn<string>("DisplayText", column => column.Nullable().WithLength(ContentItemIndex.MaxDisplayTextSize))
            );
