...
namespace OrchardCore.ContentManagement.Metadata
{
    ...
    public interface IContentDefinitionManager
    {
        ...
        IEnumerable<ContentTypeDefinition> LoadTypeDefinitions() => LoadTypeDefinitionsAsync().GetAwaiter().GetResult();
        ...
        IEnumerable<ContentTypeDefinition> ListTypeDefinitions() => ListTypeDefinitionsAsync().GetAwaiter().GetResult();
        ...
        IEnumerable<ContentPartDefinition> LoadPartDefinitions() => LoadPartDefinitionsAsync().GetAwaiter().GetResult();
        ...
        IEnumerable<ContentPartDefinition> ListPartDefinitions() => ListPartDefinitionsAsync().GetAwaiter().GetResult();
        ...
        ContentTypeDefinition LoadTypeDefinition(string name) => LoadTypeDefinitionAsync(name).GetAwaiter().GetResult();
        ...
        ContentTypeDefinition GetTypeDefinition(string name) => GetTypeDefinitionAsync(name).GetAwaiter().GetResult();
        ...
        ContentPartDefinition LoadPartDefinition(string name) => LoadPartDefinitionAsync(name).GetAwaiter().GetResult();
        ...
        ContentPartDefinition GetPartDefinition(string name) => GetPartDefinitionAsync(name).GetAwaiter().GetResult();
        ...
        void DeleteTypeDefinition(string name) => DeleteTypeDefinitionAsync(name).GetAwaiter().GetResult();
        ...
        void DeletePartDefinition(string name) => DeletePartDefinitionAsync(name).GetAwaiter().GetResult();
        ...
        void StoreTypeDefinition(ContentTypeDefinition contentTypeDefinition) => StoreTypeDefinitionAsync(contentTypeDefinition).GetAwaiter().GetResult();
        ...
        void StorePartDefinition(ContentPartDefinition contentPartDefinition) => StorePartDefinitionAsync(contentPartDefinition).GetAwaiter().GetResult();
    }
}
