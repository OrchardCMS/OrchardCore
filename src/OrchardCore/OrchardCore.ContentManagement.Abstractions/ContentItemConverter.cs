            ...
            while (reader.Read())
            {
                ...
                switch (propertyName)
                {
                    ...
                    case nameof(ContentItem.Latest):
                        contentItem.Latest = reader.TokenType is JsonTokenType.True or JsonTokenType.False && reader.GetBoolean();
                        break;
                    case nameof(ContentItem.Published):
                        contentItem.Published = reader.TokenType is JsonTokenType.True or JsonTokenType.False && reader.GetBoolean();
                        break;
