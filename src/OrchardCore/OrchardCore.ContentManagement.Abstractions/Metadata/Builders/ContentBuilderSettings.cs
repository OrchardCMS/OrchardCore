...
namespace OrchardCore.ContentManagement.Metadata.Builders
{
    public static class ContentBuilderSettings
    {
        ...
        /// </summary>
        public static readonly JsonMergeSettings JsonMergeSettings =
            new() { MergeArrayHandling = MergeArrayHandling.Union, MergeNullValueHandling = MergeNullValueHandling.Merge, };
        ...
        /// </summary>
        public static readonly JsonSerializerOptions IgnoreDefaultValuesSerializer =
            new()
            {
