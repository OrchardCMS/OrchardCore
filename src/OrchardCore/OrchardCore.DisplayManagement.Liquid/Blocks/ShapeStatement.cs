...
{
    public class ShapeStatement : TagStatement
    {
        ...
        public ShapeStatement(ArgumentsExpression arguments, List<Statement> statements = null) : base(statements)
        {
        ...
        public override async ValueTask<Completion> WriteToAsync(TextWriter writer, TextEncoder encoder, TemplateContext context)
        {
            ...
            var type = arguments["type"].ToStringValue();
            ...
            if (shape == null)
            {
                ...
                shape = await shapeFactory.CreateAsync(type, Arguments.From(properties));
            }
