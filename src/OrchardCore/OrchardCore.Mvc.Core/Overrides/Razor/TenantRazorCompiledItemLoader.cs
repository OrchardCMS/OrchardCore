...
/// </para>
/// </remarks>
public class TenantRazorCompiledItemLoader
{
    /// <summary>
    ...
    protected virtual RazorCompiledItem CreateItem(RazorCompiledItemAttribute attribute)
    {
        ...
        if (attribute.Kind == MvcViewDocumentClassifierPass.MvcViewDocumentKind)
        {
            return new TenantRazorCompiledItem(attribute.Type, attribute.Identifier);
        }

        return new TenantRazorCompiledItem(attribute.Type, attribute.Kind, attribute.Identifier);
    }
    ...
    protected static IEnumerable<RazorCompiledItemAttribute> LoadAttributes(Assembly assembly)
    {
        ArgumentNullException.ThrowIfNull(assembly);
