...
namespace OrchardCore.Themes.MyTheme
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                .DefineScript("MyTheme-vendor-jQuery")
                .SetUrl("~/MyTheme/vendor/jquery/jquery.min.js", "~/MyTheme/vendor/jquery/jquery.js")
            ...
            manifest
                .DefineScript("MyTheme-vendor-jQuery.slim")
                .SetUrl("~/MyTheme/vendor/jquery/jquery.slim.min.js", "~/MyTheme/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("MyTheme-vendor-jQuery.easing")
                .SetDependencies("MyTheme-vendor-jQuery")
                .SetUrl("~/MyTheme/vendor/jquery-easing/jquery.easing.min.js", "~/MyTheme/vendor/jquery-easing/jquery.easing.js")
            ...
            manifest
                .DefineScript("MyTheme-vendor-bootstrap")
                .SetDependencies("MyTheme-vendor-jQuery")
                .SetUrl("~/MyTheme/vendor/bootstrap/js/bootstrap.min.js", "~/MyTheme/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                .DefineScript("MyTheme-vendor-bootstrap-bundle")
                .SetDependencies("MyTheme-vendor-jQuery")
                .SetUrl("~/MyTheme/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/MyTheme/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                .DefineStyle("MyTheme-vendor-bootstrap")
                .SetUrl("~/MyTheme/vendor/bootstrap/css/bootstrap.min.css", "~/MyTheme/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                .DefineStyle("MyTheme-bootstrap-oc")
                .SetUrl("~/MyTheme/css/bootstrap-oc.min.css", "~/MyTheme/css/bootstrap-oc.css")
                .SetVersion("1.0.0");
				
            manifest
                .DefineStyle("MyTheme-vendor-font-awesome")
                .SetUrl("~/MyTheme/vendor/fontawesome-free/css/all.min.css", "~/MyTheme/vendor/fontawesome-free/css/all.css")
            ...
            manifest
                .DefineScript("MyTheme-vendor-font-awesome")
