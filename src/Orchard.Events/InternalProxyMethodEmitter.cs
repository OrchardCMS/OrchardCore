...
{
    public class InternalProxyMethodEmitter { 
        private static readonly ProxyTypeCache _cache = new ProxyTypeCache();

        public static Func<object, object, bool> CreateProxyMethod(MethodInfo method, Type inputType, IDictionary<string, object> parametersValues) {
