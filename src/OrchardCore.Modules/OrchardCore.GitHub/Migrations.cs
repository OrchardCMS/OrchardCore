...
{
    private const string ProtectorName = GitHubConstants.Features.GitHubAuthentication;
    ...
    private async Task MigrateClientSecretAsync()
    {
        ...
        var settings = site.As<GitHubAuthenticationSettings>();
...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        try
        {
            ...
            {
                Description = "Migrated from GitHub authentication settings",
            });
