...
namespace OrchardCore.Search.Elasticsearch
{
    ...
    public class ElasticsearchContentPickerShapeProvider : IShapeAttributeProvider
    {
        private readonly IStringLocalizer S;

        public ElasticsearchContentPickerShapeProvider(IStringLocalizer<ElasticsearchContentPickerShapeProvider> stringLocalizer)
        {
            S = stringLocalizer;
        }
