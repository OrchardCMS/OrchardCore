...
namespace OrchardCore.Search.Elasticsearch.GraphQL.Queries
{
    public class ElasticsearchQueryFieldTypeProvider : ISchemaBuilder
    {
        ...
        private readonly ILogger<ElasticsearchQueryFieldTypeProvider> _logger;

        public ElasticsearchQueryFieldTypeProvider(IHttpContextAccessor httpContextAccessor, ILogger<ElasticsearchQueryFieldTypeProvider> logger)
        {
        ...
        public async Task BuildAsync(ISchema schema)
        {
            ...
            foreach (var query in queries.OfType<ElasticsearchQuery>())
            {
        ...
        private FieldType BuildSchemaBasedFieldType(ElasticsearchQuery query, JToken querySchema, string fieldTypeName)
        {
        ...
        private FieldType BuildContentTypeFieldType(ISchema schema, string contentType, ElasticsearchQuery query, string fieldTypeName)
        {
