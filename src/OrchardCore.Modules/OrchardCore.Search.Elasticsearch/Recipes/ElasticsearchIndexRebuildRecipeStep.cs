...
public sealed class ElasticsearchIndexRebuildRecipeStep : RecipeImportStep<ElasticsearchIndexRebuildRecipeStep.ElasticsearchIndexRebuildStepModel>
{
    private readonly IIndexProfileManager _indexProfileManager;
    private readonly IServiceProvider _serviceProvider;

    public ElasticsearchIndexRebuildRecipeStep(
    ...
    public override string Name => "elastic-index-rebuild";
    ...
    protected override JsonSchema BuildSchema()
    {
        return new RecipeStepSchemaBuilder()
            ...
            .Description("Rebuilds Elasticsearch indexes.")
            .Required("name")
            .Properties(
    ...
    protected override async Task ImportAsync(ElasticsearchIndexRebuildStepModel model, RecipeExecutionContext context)
    {
    ...
    public sealed class ElasticsearchIndexRebuildStepModel
    {
