...
{
    /// <summary>
    /// This class persists the indexing state, a cursor, on the filesystem.
    /// This state has to be on the filesystem for each website instances.
    /// It is still used by the reset index method.
    /// </summary>
    public class ElasticIndexingState
    {
