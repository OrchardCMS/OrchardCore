...
namespace OrchardCore.Search.Elasticsearch
{
    ...
    public class ElasticsearchIndexingService
    {
        ...
        private readonly ElasticsearchIndexingState _indexingState;
        ...
        public ElasticsearchIndexingService(
            ...
            ElasticsearchIndexingState indexingState,
        ...
        public async Task ProcessContentItemsAsync(string indexName = default)
        {
            ...
            IEnumerable<ElasticsearchIndexSettings> indexSettingsList = null;
            ...
            else
            {
                ...
                indexSettingsList = new ElasticsearchIndexSettings[1] { settings }.AsEnumerable();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task CreateIndexAsync(ElasticsearchIndexSettings elasticIndexSettings)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task UpdateIndexAsync(ElasticsearchIndexSettings elasticIndexSettings)
        {
        ...
        /// </summary>
        public async Task RebuildIndexAsync(ElasticsearchIndexSettings elasticIndexSettings)
        {
        ...
        public async Task<ElasticsearchSettings> GetElasticSettingsAsync()
        {
            var siteSettings = await _siteService.GetSiteSettingsAsync();

            if (siteSettings.Has<ElasticsearchSettings>())
            {
                return siteSettings.As<ElasticsearchSettings>();
            }
            else
            {
