...
public static class ElasticsearchIndexPermissionHelper
{
    ...
    public static readonly Permission ManageElasticIndexes = ElasticsearchPermissions.ManageElasticIndexes;

    private static readonly Permission _indexPermissionTemplate = new("QueryElasticsearch{0}Index", "Query Elasticsearch {0} Index", [ElasticsearchPermissions.ManageElasticIndexes]);
