...
namespace OrchardCore.Contents.Workflows.Activities
{
    ...
    {
        public RetrieveContentTask(IContentManager contentManager, IWorkflowScriptEvaluator scriptEvaluator, IStringLocalizer<RetrieveContentTask> localizer)
        ...
        {
            var contentItemId =
                (await GetContentItemIdAsync(workflowContext))
