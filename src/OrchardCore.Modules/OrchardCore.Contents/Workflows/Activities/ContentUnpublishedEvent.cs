...
namespace OrchardCore.Contents.Workflows.Activities
{
    ...
    {
        public ContentUnpublishedEvent(IContentManager contentManager, IWorkflowScriptEvaluator scriptEvaluator, IStringLocalizer<ContentUnpublishedEvent> localizer)
