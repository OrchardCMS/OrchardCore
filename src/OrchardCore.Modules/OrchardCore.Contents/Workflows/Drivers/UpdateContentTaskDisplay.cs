...
{
    public class UpdateContentTaskDisplay : ContentTaskDisplayDriver<UpdateContentTask, UpdateContentTaskViewModel>
    {
        private readonly IContentDefinitionManager _contentDefinitionManager;

        public UpdateContentTaskDisplay(IContentDefinitionManager contentDefinitionManager)
        {
