        ...
        public void Build(QueryEngineBuilder<ContentItem> builder)
        {
            builder
                .WithNamedTerm(
                    ...
                    builder =>
                        builder
                            ...
                            .MapFrom<ContentOptionsViewModel>(
                                (model) =>
                                {
                            ...
                            .OneCondition(
                                async (contentType, query, ctx) =>
                                {
                                    ...
                                    return query
                                        ...
                                        .Where(x => x.ContentType.IsIn(listAnyContentTypes) || (x.ContentType.IsIn(listOwnContentTypes) && x.Owner == userNameIdentifier));
                                }
                            )
                            .MapTo<ContentOptionsViewModel>(
                                (val, model) =>
                ...
                .WithNamedTerm(
                    "stereotype",
                    builder =>
                        builder.OneCondition(
                            async (stereotype, query, ctx) =>
                            {
                                var context = (ContentQueryContext)ctx;
                                var httpContextAccessor = context.ServiceProvider.GetRequiredService<IHttpContextAccessor>();
                                var authorizationService = context.ServiceProvider.GetRequiredService<IAuthorizationService>();
