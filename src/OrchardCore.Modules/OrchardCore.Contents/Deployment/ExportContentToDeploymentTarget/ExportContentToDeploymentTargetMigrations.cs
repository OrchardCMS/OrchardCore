...
namespace OrchardCore.Contents.Deployment.ExportContentToDeploymentTarget
{
    ...
    public class ExportContentToDeploymentTargetMigrations : DataMigration
    {
        ...
        public ExportContentToDeploymentTargetMigrations(IRecipeMigrator recipeMigrator, IDeploymentPlanService deploymentPlanService, ISiteService siteService)
        {
        ...
        public async Task<int> CreateAsync()
        {
            ...
            if (exportContentToDeploymentTargetPlan != null)
            {
                ...
                siteSettings.Alter<ExportContentToDeploymentTargetSettings>(
                    nameof(ExportContentToDeploymentTargetSettings),
                    aspect => aspect.ExportContentToDeploymentTargetPlanId = exportContentToDeploymentTargetPlan.Id
                );
