...
namespace OrchardCore.Contents.Deployment.AddToDeploymentPlan
{
    public class ContentItemDeploymentStepDriver : DisplayDriver<DeploymentStep, ContentItemDeploymentStep>
    {
        ...
        public ContentItemDeploymentStepDriver(IContentManager contentManager, IStringLocalizer<ContentItemDeploymentStepDriver> stringLocalizer)
        {
        ...
        {
            return Initialize<ContentItemDeploymentStepViewModel>(
                    "ContentItemDeploymentStep_Fields_Edit",
                    model =>
                    {
