...
namespace OrchardCore.Contents.Indexing
{
    public class AspectsContentIndexHandler : IContentItemIndexHandler
    {
        ...
        public async Task BuildIndexAsync(BuildIndexContext context)
        {
            ...
            {
                context.DocumentIndex.Set(IndexingConstants.BodyAspectBodyKey, body.Body, DocumentIndexOptions.Sanitize);
            }

            context.DocumentIndex.Set(IndexingConstants.DisplayTextAnalyzedKey, context.ContentItem.DisplayText, DocumentIndexOptions.Sanitize);
