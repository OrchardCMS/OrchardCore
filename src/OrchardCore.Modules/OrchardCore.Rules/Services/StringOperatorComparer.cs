...
namespace OrchardCore.Rules.Services
{
    public class StringEqualsOperatorComparer : OperatorComparer<StringOperator, string>
    {
        public override bool Compare(StringOperator conditionOperator, string a, string b) =>
            conditionOperator.CaseSensitive ? string.Equals(a, b) : string.Equals(a, b, StringComparison.OrdinalIgnoreCase);
    }
    ...
    {
        public override bool Compare(StringOperator conditionOperator, string a, string b) =>
            conditionOperator.CaseSensitive ? a.StartsWith(b) : a.StartsWith(b, StringComparison.OrdinalIgnoreCase);
    }
    ...
    {
        public override bool Compare(StringOperator conditionOperator, string a, string b) =>
            conditionOperator.CaseSensitive ? a.EndsWith(b) : a.EndsWith(b, StringComparison.OrdinalIgnoreCase);
    }
    ...
    {
        public override bool Compare(StringOperator conditionOperator, string a, string b) =>
            conditionOperator.CaseSensitive ? a.Contains(b) : a.Contains(b, StringComparison.OrdinalIgnoreCase);
    }
