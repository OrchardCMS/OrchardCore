...
namespace OrchardCore.Rules.Services
{
    public class IsAuthenticatedConditionEvaluator : ConditionEvaluator<IsAuthenticatedCondition>
    {
        ...
        public override ValueTask<bool> EvaluateAsync(IsAuthenticatedCondition condition) => _httpContextAccessor.HttpContext.User?.Identity.IsAuthenticated == true ? True : False;
    }
}
