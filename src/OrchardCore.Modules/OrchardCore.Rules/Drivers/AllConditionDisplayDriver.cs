...
namespace OrchardCore.Rules.Drivers
{
    public class AllConditionDisplayDriver : DisplayDriver<Condition, AllConditionGroup>
    {
        ...
        public override Task<IDisplayResult> EditAsync(AllConditionGroup condition, BuildEditorContext context)
        {
            return Task.FromResult<IDisplayResult>(
                Initialize<AllConditionViewModel>("AllCondition_Fields_Edit", m =>
                {
