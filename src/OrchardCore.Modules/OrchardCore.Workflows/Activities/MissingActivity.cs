...
namespace OrchardCore.Workflows.Activities
{
    ...
    public class MissingActivity : Activity
    {
        ...
        {
            _logger.LogWarning($"Activity {MissingActivityRecord.Name} is no longer available. This can happen if the feature providing the activity is no longer enabled. Either enable the feature, or remove this activity from workflow definition with ID {workflowContext.WorkflowDefinitionRecord.Id}");
            return Noop();
        }
    }
}