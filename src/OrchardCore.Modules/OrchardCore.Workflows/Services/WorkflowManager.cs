...
namespace OrchardCore.Workflows.Services
{
    public class WorkflowManager : IWorkflowManager
    {
        ...
        private async Task<object> SerializeAsync(object value)
        {
            ...
            await _workflowValueSerializers.Resolve().InvokeAsync((x, context) => x.SerializeValueAsync(context), context, _logger);
        ...
        {
            var context = new SerializeWorkflowValueContext(value);
            await _workflowValueSerializers.Resolve().InvokeAsync((x, context) => x.DeserializeValueAsync(context), context, _logger);
            return context.Output;
        }
    }
}
