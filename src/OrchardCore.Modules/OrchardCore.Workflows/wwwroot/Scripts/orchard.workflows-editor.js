...
var applyFilter = function applyFilter(category, q) {
  ...
  var $cards = $('.activity').show(); // Remove activities whoes type doesn't match the configured activity type.
  ...
  $('.activity-picker-categories [data-category]').each(function (i, el) {
    ...
    var activityCount = $(".activity[data-category='".concat(category, "'][data-activity-type='").concat(type, "']")).length;
