            ...
            return Initialize<ContentSettingsViewModel>(
                    ...
                    model =>
                    {
                        model.ContentSettingsEntries.Add(
                            new ContentSettingsEntry { ShapeType = contentPartDefinition.Name, Description = S["Placement for a {0} part", displayName] }
                        );
                        ...
                        model.ContentSettingsEntries.Add(
                            new ContentSettingsEntry { ShapeType = $"{contentPartDefinition.Name}_Edit", Description = S["Placement in admin editor for a {0} part", displayName] }
                        );
                    }
                )
                .Location("Shortcuts");
