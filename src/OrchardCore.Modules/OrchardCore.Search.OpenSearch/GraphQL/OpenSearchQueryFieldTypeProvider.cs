...
namespace OrchardCore.Search.OpenSearch.GraphQL.Queries;

public sealed class OpenSearchQueryFieldTypeProvider : ISchemaBuilder
{
    ...
    public OpenSearchQueryFieldTypeProvider(
        IHttpContextAccessor httpContextAccessor,
        IStringLocalizer<OpenSearchQueryFieldTypeProvider> stringLocalizer,
        ILogger<OpenSearchQueryFieldTypeProvider> logger)
    {
    ...
    public async Task BuildAsync(ISchema schema)
    {
        ...
        var queries = await queryManager.ListQueriesBySourceAsync(OpenSearchQuerySource.SourceName);
