...
using OrchardCore.Search.OpenSearch.Core.Handlers;
using OrchardCore.Search.OpenSearch.Core.Models;
using OrchardCore.Search.OpenSearch.Core.Providers;
using OrchardCore.Search.OpenSearch.Core.Recipes;
using OrchardCore.Search.OpenSearch.Core.Services;
using OrchardCore.Search.OpenSearch.Drivers;
using OrchardCore.Search.OpenSearch.Migrations;
using OrchardCore.Search.OpenSearch.Services;
...
[Feature("OrchardCore.Search.OpenSearch.ContentPicker")]
