...
{
    /// <summary>
    /// Represents settings for SMTP.
    /// </summary>
    public class SmtpSettingsEditViewModel : IValidatableObject
    {
        /// <summary>
        ...
        {
            var S = validationContext.GetService<IStringLocalizer<SmtpSettingsEditViewModel>>();
