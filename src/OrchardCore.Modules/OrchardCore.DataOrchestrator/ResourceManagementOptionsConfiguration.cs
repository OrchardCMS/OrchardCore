...
public sealed class ResourceManagementOptionsConfiguration : IConfigureOptions<ResourceManagementOptions>
{
    ...
    static ResourceManagementOptionsConfiguration()
    {
        ...
        _manifest
            .DefineScript("etl-pipeline-editor")
            .SetDependencies("jsplumb", "bootstrap")
            .SetUrl(
                "~/OrchardCore.DataOrchestrator/Scripts/etl-pipeline-editor.min.js",
                "~/OrchardCore.DataOrchestrator/Scripts/etl-pipeline-editor.js")
            .SetVersion("1.0.0");

        _manifest
            .DefineStyle("etl-pipeline-editor")
            .SetUrl(
                "~/OrchardCore.DataOrchestrator/Styles/etl-pipeline-editor.min.css",
                "~/OrchardCore.DataOrchestrator/Styles/etl-pipeline-editor.css")
            .SetVersion("1.0.0");
    }
