...
namespace Orchard.UserCenter
{
    ...
    /// </summary>
    public class UserCenterAttribute : ActionFilterAttribute
    {
        ...
        public static void Apply(HttpContext context)
        {
            ...
            context.Items[typeof(UserCenterAttribute)] = null;
        }

        public static bool IsApplied(HttpContext context)
        {
            object value;
            return context.Items.TryGetValue(typeof(UserCenterAttribute), out value);
        }
    }
}
