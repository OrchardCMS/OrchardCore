        ...
        builder.Describe("Content")
            .OnDisplaying(displaying =>
            {
                ...
                if (autoroutePart != null)
                {
                    ...
                    // Content__Slug__[Slug] e.g. Content-Slug-example, Content-Slug-my-page
                    displaying.Shape.Metadata.Alternates.Add("Content__Slug__" + encodedSlug);
                    
                    // Content_[DisplayType]__Slug__[Slug] e.g. Content-Slug-example.Summary, Content-Slug-my-page.Summary
