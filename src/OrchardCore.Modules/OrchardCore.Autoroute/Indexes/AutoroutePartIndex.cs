...
{
    [Obsolete("AutoroutePartIndex is deprecated, please use OrchardCore.Autoroute.Indexes.AutoroutePartIndex instead.", true)]
    ...
    [Obsolete("AutoroutePartIndexProvider is deprecated, please use OrchardCore.Autoroute.Indexes.AutoroutePartIndexProvider instead.", true)]
