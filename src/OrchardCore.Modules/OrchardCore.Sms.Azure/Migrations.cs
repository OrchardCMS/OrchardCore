...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        try
        {
            ...
            {
                _logger.LogWarning(ex, "Could not decrypt Azure SMS connection string. It may not be encrypted or may be corrupted. Attempting to use as plain text.");
            ...
            {
                Description = "Migrated from Azure SMS settings",
            });
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            _logger.LogError(ex, "Failed to migrate Azure SMS connection string to secrets.");
        }
    }
}
