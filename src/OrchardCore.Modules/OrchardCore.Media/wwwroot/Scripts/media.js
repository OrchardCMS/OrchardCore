...
Vue.component('mediaFieldThumbsContainer', {
                    ...
                    <div v-if="media.mediaPath!== \'not-found\'">\
                        <div class="thumb-container" :style="{height: thumbSize + \'px\'}" >\
                         ...
                         <div class="media-container-main-item-title card-body">\
                                ...
                                <span class="media-filename card-text small" :title="media.mediaPath">{{media.vuekey}}</span>\
                         </div>\
                    </div>\
                    <div v-else>\
    ...
    //computed: {
    //    mediaItemsWithVueKey: function () {
    //        var keyedList = this.mediaItems;

    //        keyedList.forEach(function (item, index) {
    //            item.aaakey = index;
    //        });
