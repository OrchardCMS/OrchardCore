...
namespace OrchardCore.Media
{
    public class Permissions : IPermissionProvider
    {
        ...
        public static readonly Permission ManageMediaOptions = new Permission("ManageMediaOptions", "Manage Media Options");
        ...
        public IEnumerable<PermissionStereotype> GetDefaultStereotypes()
        {
            return new[]
            {
                ...
                {
                    Name = "Administrator",
                    Permissions = new[] { ManageMedia, ManageAttachedMediaFieldsFolder, ManageMediaProfiles, ManageMediaOptions }
                },
                new PermissionStereotype
                {
                    Name = "Editor",
