...
vi.mock("../components/MediaFieldBasic.vue", () => ({
  default: {
    ...
    template: "<div class='stub-basic' :data-media-app-translations='config?.mediaAppTranslations' :data-signalr-enabled='config?.signalrEnabled' :data-disable-thumbnails='config?.disableThumbnails'></div>",
