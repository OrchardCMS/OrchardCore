...
namespace OrchardCore.AuditTrail.Migrations
{
    public class AuditTrailMigrations : DataMigration
    {
        ...
        public int Create()
        {
            ...
            SchemaBuilder.CreateMapIndexTable(nameof(AuditTrailEventIndex), table => table
            ...
            SchemaBuilder.CreateMapIndexTable(nameof(ContentAuditTrailEventIndex), table => table
