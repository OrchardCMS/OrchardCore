...
namespace OrchardCore.Apis.OpenApi
{
    ...
    /// </summary>
    public class OpenApiJsonOutputFormatter : TextOutputFormatter
    {

        /// <summary>
        /// Initializes a new <see cref="OpenApiJsonOutputFormatter"/> instance.
        /// </summary>
        public OpenApiJsonOutputFormatter()
        {
