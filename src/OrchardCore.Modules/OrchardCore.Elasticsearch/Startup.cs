...
using OrchardCore.Elasticsearch.Core.Providers;
...
using OrchardCore.Elasticsearch.Services;
...
public sealed class Startup : StartupBase
{
    ...
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddBreadcrumbProvider<ElasticsearchBreadcrumbProvider>();
...
[Feature("OrchardCore.Search.Elasticsearch")]
...
internal sealed class LegacyFeatureMigrations : DataMigration
{
    public static int Create()
    {
        ShellScope.AddDeferredTask(async scope =>
        {
            ...
            if (await featuresManager.IsFeatureEnabledAsync("OrchardCore.Elasticsearch"))
            {
                return;
            }

            await featuresManager.EnableFeaturesAsync("OrchardCore.Elasticsearch");
        });
