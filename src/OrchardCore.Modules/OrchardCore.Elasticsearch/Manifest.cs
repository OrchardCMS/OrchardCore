...
[assembly: Feature(
    ...
    Description = "Obsolete legacy feature ID kept for backwards compatibility. Enables OrchardCore.Elasticsearch automatically.",
    Dependencies = ["OrchardCore.Elasticsearch"],
    Category = "Search"
)]
