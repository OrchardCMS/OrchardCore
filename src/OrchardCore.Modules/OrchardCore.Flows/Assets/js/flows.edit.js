...
$(function () {
    ...
    $(document).on('click', '.btn.toggleAll', function (e) {
        ...
        if(iscollapsed)
        {
            $('.toggleAll > svg.fa-angle-double-down')
                .toggleClass('fa-angle-double-down fa-angle-double-up');

            $('.widget-template .widget.widget-editor.card.collapsed')
                .filter(':not(.widget-nocollapse)')
                .removeClass('collapsed');
            
        }
        else
        {
            $('.toggleAll > svg.fa-angle-double-up')
                .toggleClass('fa-angle-double-down fa-angle-double-up');

            $('.widget-template .widget.widget-editor.card')
                .filter(':not(.widget-nocollapse):not(.collapsed)')
                .addClass('collapsed');
        }
