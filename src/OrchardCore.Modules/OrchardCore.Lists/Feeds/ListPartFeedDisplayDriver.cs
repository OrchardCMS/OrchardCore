...
namespace OrchardCore.Lists.Feeds
{
    public class ListPartFeedDisplayDriver : ContentPartDisplayDriver<ListPart>
    {
        ...
        public override IDisplayResult Edit(ListPart part)
        {
            ...
            {
                m.EnableFeedProxyUrl = part.ContentItem.Content.ListPart.EnableFeedProxyUrl ?? true;
        ...
        public override async Task<IDisplayResult> UpdateAsync(ListPart part, IUpdateModel updater)
        {
            ...
            await updater.TryUpdateModelAsync(model, Prefix, t => t.EnableFeedProxyUrl, t => t.FeedProxyUrl, t => t.FeedItemsCount);

            part.ContentItem.Content.ListPart.EnableFeedProxyUrl = model.EnableFeedProxyUrl;
