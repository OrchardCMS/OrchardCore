...
namespace OrchardCore.OpenId.Drivers
{
    public class OpenIdServerSettingsDisplayDriver : DisplayDriver<OpenIdServerSettings>
    {
        ...
        public OpenIdServerSettingsDisplayDriver(IOpenIdServerService serverService) => _serverService = serverService;
        ...
        public override Task<IDisplayResult> EditAsync(OpenIdServerSettings settings, BuildEditorContext context) =>
            Task.FromResult<IDisplayResult>(
                Initialize<OpenIdServerSettingsViewModel>(
                        "OpenIdServerSettings_Edit",
                        async model =>
                        {
                            ...
                            {
                                model.AvailableCertificates.Add(
                                    new CertificateInfo
                                    {
