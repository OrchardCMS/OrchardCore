    ...
    : DeploymentSourceBase<OpenIdServerDeploymentStep>
{
    ...
    protected override async Task ProcessAsync(OpenIdServerDeploymentStep step, DeploymentPlanResult result)
    {
        ...
        var settingsModel = new OpenIdServerSettingsStepModel
        {
            ...
            EnableDeviceAuthorizationEndpoint = !string.IsNullOrWhiteSpace(settings.DeviceAuthorizationEndpointPath),
            EnableEndUserVerificationEndpoint = !string.IsNullOrWhiteSpace(settings.EndUserVerificationEndpointPath),
            ...
            AllowDeviceAuthorizationFlow = settings.AllowDeviceAuthorizationFlow,
