...
namespace OrchardCore.AdminDashboard
{
    public class Startup : StartupBase
    {
        ...
        public override void Configure(IApplicationBuilder builder, IEndpointRouteBuilder routes, IServiceProvider serviceProvider)
        {
            ...
            routes.MapAreaControllerRoute(
                name: "AdminDashboardWidgets",
                areaName: "OrchardCore.AdminDashboard",
                pattern: _adminOptions.AdminUrlPrefix + "/Dashboard/Widgets",
                defaults: new { controller = dashboardControllerName, action = nameof(DashboardController.Widgets) }
            );
        }
    }
}
