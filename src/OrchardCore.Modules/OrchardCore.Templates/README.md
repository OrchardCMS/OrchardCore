...
Some modules (namely the OrchardCore.Users module) allow you to override some of it's views in your Theme. Since these views are not 
...
For example, if you want to overide the `OrchardCore.Users\Views\Account\Login.cshtml` view you would need to create a file in your theme and place 
