...
public sealed class ReferrerPolicySettingsDisplayDriver : SiteDisplayDriver<SecuritySettings>
{
    ...
    public ReferrerPolicySettingsDisplayDriver(
    ...
    public override async Task<IDisplayResult> EditAsync(ISite site, SecuritySettings settings, BuildEditorContext context)
    {
        ...
        return Initialize<SecuritySettingsViewModel>("ReferrerPolicySettings_Edit", model =>
        {
