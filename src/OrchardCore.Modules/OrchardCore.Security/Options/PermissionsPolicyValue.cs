...
public class PermissionsPolicyValue
{
    ...
    public const string LegacyImageFormat = "legacy-image-format";
    ...
    public const string PublicKeyRetrieval = "publickey-credentials-get";
    ...
    public const string WebXR = "xr-spatial-tracking";
}
