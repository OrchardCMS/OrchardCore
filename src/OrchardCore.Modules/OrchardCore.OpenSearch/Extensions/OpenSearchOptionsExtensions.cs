...
internal static class OpenSearchOptionsExtensions
{
    internal static OpenSearchOptions AddAnalyzers(this OpenSearchOptions options, IConfigurationSection configuration)
    {
        ...
        if (options.Analyzers.Count == 0)
        {
            ...
            options.Analyzers.Add(OpenSearchConstants.DefaultAnalyzer, new JsonObject
            {
                ["type"] = OpenSearchConstants.DefaultAnalyzer,
            });
        }
    ...
    internal static OpenSearchOptions AddTokenFilters(this OpenSearchOptions options, IConfigurationSection configuration)
    {
    ...
    internal static OpenSearchOptions AddIndexPrefix(this OpenSearchOptions options, IConfigurationSection configuration)
    {
