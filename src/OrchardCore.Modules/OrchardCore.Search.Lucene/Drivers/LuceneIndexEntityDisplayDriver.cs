...
internal sealed class LuceneIndexEntityDisplayDriver : DisplayDriver<IndexEntity>
{
    private readonly LuceneAnalyzerManager _luceneAnalyzerManager;

    internal readonly IStringLocalizer S;

    public LuceneIndexEntityDisplayDriver(
        LuceneAnalyzerManager luceneAnalyzerManager,
        IStringLocalizer<LuceneIndexEntityDisplayDriver> stringLocalizer)
    {
    ...
    public override IDisplayResult Display(IndexEntity index, BuildDisplayContext context)
    {
        ...
        return View("LuceneIndexEntity_ActionsMenuItems_SummaryAdmin", index)
    ...
    public override IDisplayResult Edit(IndexEntity index, BuildEditorContext context)
    {
        ...
        var data = Initialize<LuceneIndexEntityViewModel>("LuceneIndexEntity_Edit", model =>
        {
    ...
    public override async Task<IDisplayResult> UpdateAsync(IndexEntity index, UpdateEditorContext context)
    {
        ...
        var model = new LuceneIndexEntityViewModel();
