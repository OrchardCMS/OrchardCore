...
namespace OrchardCore.Search.Lucene.Drivers
{
    public class LuceneQueryDisplayDriver : DisplayDriver<Query, LuceneQuery>
    {
        ...
        public LuceneQueryDisplayDriver(IStringLocalizer<LuceneQueryDisplayDriver> stringLocalizer, LuceneIndexSettingsService luceneIndexSettingsService)
        {
        ...
        public override IDisplayResult Display(LuceneQuery query, IUpdateModel updater)
        {
            return Combine(
                Dynamic(
                    ...
                    .Location("Content:5"),
                Dynamic(
                        "LuceneQuery_Buttons_SummaryAdmin",
                        model =>
                        {
                            model.Query = query;
                        }
        ...
        {
            return Initialize<LuceneQueryViewModel>(
                    "LuceneQuery_Edit",
                    async model =>
                    {
