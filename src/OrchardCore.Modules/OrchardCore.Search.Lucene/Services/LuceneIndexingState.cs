    ...
    public class LuceneIndexingState
    {
            ...
            )
        {
            ...
            if (!File.Exists(_indexSettingsFilename))
            {
                ...
                File.WriteAllText(_indexSettingsFilename, new JsonObject().ToJsonString(JNode.OptionsIndented));
            }
        ...
        public void Update()
        {
            lock (this)
            {
                File.WriteAllText(_indexSettingsFilename, _content.ToJsonString(JNode.OptionsIndented));
            }
        }
    }
}
