...
namespace OrchardCore.ContentFields.Indexing.SQL
{
    ...
    public class UserPickerMigrations : DataMigration
    {
        ...
        {
            await SchemaBuilder.CreateMapIndexTableAsync<UserPickerFieldIndex>(table =>
                table
            ...
            await SchemaBuilder.AlterIndexTableAsync<UserPickerFieldIndex>(table =>
                table.CreateIndex("IDX_UserPickerFieldIndex_DocumentId", "DocumentId", "ContentItemId", "ContentItemVersionId", "Published", "Latest")
            );
            ...
            await SchemaBuilder.AlterIndexTableAsync<UserPickerFieldIndex>(table =>
                table.CreateIndex(
                    "IDX_UserPickerFieldIndex_DocumentId_ContentType",
                    "DocumentId",
                    "ContentType(254)",
                    "ContentPart(254)",
                    "ContentField(254)",
            ...
            await SchemaBuilder.AlterIndexTableAsync<UserPickerFieldIndex>(table =>
                table.CreateIndex("IDX_UserPickerFieldIndex_DocumentId_SelectedUserId", "DocumentId", "SelectedUserId", "Published", "Latest")
            );
