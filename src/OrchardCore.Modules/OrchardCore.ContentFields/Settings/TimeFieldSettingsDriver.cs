...
namespace OrchardCore.ContentFields.Settings
{
    public class TimeFieldSettingsDriver : ContentPartFieldDefinitionDisplayDriver<TimeField>
    {
        ...
        public TimeFieldSettingsDriver(IOptions<JsonSerializerOptions> jsonSerializerOptions)
        {
        ...
        public override IDisplayResult Edit(ContentPartFieldDefinition partFieldDefinition)
        {
            ...
            {
                var settings = partFieldDefinition.Settings.ToObject<TimeFieldSettings>(_jsonSerializerOptions);
