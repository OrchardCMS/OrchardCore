...
namespace OrchardCore.ContentFields.TagHelpers
{
    /// <summary>
    /// <see cref="ITagHelper"/> implementation targeting &lt;datalist&gt; elements with <c>asp-for</c> and/or
    ...
    public class DataListTagHelper : TagHelper
    {
        ...
        public override void Init(TagHelperContext context)
        {
            ...
            if (For == null)
            {
                // Informs contained elements that they're running within a targeted <datalist/> element.
            ...
            context.Items[typeof(DataListTagHelper)] = currentValues;
        }
