...
namespace OrchardCore.Deployment.Remote.Services
{
    public class RemoteInstanceService
    {
        ...
        public async Task CreateRemoteInstanceAsync(string name, string url, string clientName, string apiKey, string rsaSecret)
        {
            var remoteInstanceList = await LoadRemoteInstanceListAsync();
        ...
        public async Task UpdateRemoteInstance(string id, string name, string url, string clientName, string apiKey, string rsaSecret)
        {
            var remoteInstanceList = await LoadRemoteInstanceListAsync();
            var remoteInstance = FindRemoteInstance(remoteInstanceList, id);
