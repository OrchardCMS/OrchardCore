...
(function ($) {
  ...
  $.extend(true, $.trumbowyg, {
    plugins: {
      ...
      resizimg: {
        //created from original trumbowyg resizer code adn improved
        init: function init(trumbowyg) {
          ...
          function initResizable() {
            trumbowyg.$ed.find('img').off('click').on('click', function (ev) {
          ...
          trumbowyg.$c.on('tbwinit', function (ev) {
            ...
            trumbowyg.$ed.on('click', function (ev) {
              ...
              ev.preventDefault();
              ev.stopPropagation(); //check if I've clicked out of canvas or image to reset it

              if (!($(ev.target).is('img') || ev.target.id === rszwtcanvas.canvasId())) {
                rszwtcanvas.reset(); //save changes
          ...
          trumbowyg.$c.on('tbwresize', function (ev) {
            rszwtcanvas.reCalcOffset();
          }); // Destroy
