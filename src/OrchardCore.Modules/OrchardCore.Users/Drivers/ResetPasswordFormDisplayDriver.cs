...
{
    public override Task<IDisplayResult> EditAsync(ResetPasswordForm model, BuildEditorContext context)
    {
        return Task.FromResult<IDisplayResult>(
            Initialize<ResetPasswordViewModel>("ResetPasswordFormIdentifier", vm =>
            {
