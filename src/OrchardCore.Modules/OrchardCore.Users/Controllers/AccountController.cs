...
namespace OrchardCore.Users.Controllers
{
    ...
    public class AccountController : AccountBaseController
    {
        ...
        private async Task<SignInResult> ExternalLoginSignInAsync(IUser user, ExternalLoginInfo info)
        {
            ...
            {
                // Some checking may be necessary here,
                // because we cannot be sure that the json generated by the user through the script is correct, such as the CustomUserSettings
                (user as User).Properties.Merge(context.PropertiesToUpdate, new JsonMergeSettings
                {
