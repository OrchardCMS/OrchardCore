...
{
    public class UserDeletedEventDisplay : ActivityDisplayDriver<UserDeletedEvent, UserDeletedEventViewModel>
    {
        public UserDeletedEventDisplay(IUserService userService)
        {
