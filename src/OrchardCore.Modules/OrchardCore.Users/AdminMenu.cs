        ...
        public Task BuildNavigationAsync(string name, NavigationBuilder builder)
        {
            ...
            builder.Add(S["Security"], NavigationConstants.AdminMenuSecurityPosition, security => security
                    .AddClass("security").Id("security")
                        .Add(S["Users"], S["am-Users"], users => users
                        ...
                        .Add(S["Settings"], settings => settings
                            .Add(S["Login"], S["am-Login"], login => login
                                .Permission(Permissions.ManageUsers)
        ...
        public Task BuildNavigationAsync(string name, NavigationBuilder builder)
        {
            ...
            builder
                .Add(S["Security"], security => security
                    .Add(S["Settings"], settings => settings
                        .Add(S["Email"], S["am-Email"], registration => registration
                            .Permission(Permissions.ManageUsers)
    ...
    public class RegistrationAdminMenu : INavigationProvider
    {
        ...
        public Task BuildNavigationAsync(string name, NavigationBuilder builder)
        {
            ...
            builder
                .Add(S["Security"], security => security
                    .Add(S["Settings"], settings => settings
                        .Add(S["Registration"], S["am-Registration"], registration => registration
                            .Permission(Permissions.ManageUsers)
    ...
    public class ResetPasswordAdminMenu : INavigationProvider
    {
        ...
        public Task BuildNavigationAsync(string name, NavigationBuilder builder)
        {
            ...
            builder
                .Add(S["Security"], security => security
                    .Add(S["Settings"], settings => settings
                        .Add(S["Reset password"], S["am-Reset password"], password => password
                            .Permission(Permissions.ManageUsers)
