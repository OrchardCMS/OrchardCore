        ...
        public int UpdateFrom12()
        {
            ShellScope.AddDeferredTask(async scope =>
            {
                ...
                try
                {
                    ...
                    var updateCmd = $"UPDATE {quotedTableName} " +
                                    $"SET {quotedContentColumnName} = REPLACE({quotedContentColumnName}, 'OrchardCore.Users.Models.LoginSettings, OrchardCore.Users', 'OrchardCore.Users.Models.LoginSettings, OrchardCore.Users.Core') " +
                                    $"WHERE {quotedTypeColumnName}  = 'OrchardCore.Deployment.DeploymentPlan, OrchardCore.Deployment.Abstractions' ";
