...
namespace OrchardCore.Localization
{
    ...
    {
        private static readonly RouteValueDictionary _routeValues = new() { { "area", "OrchardCore.Settings" }, { "groupId", LocalizationSettingsDisplayDriver.GroupId }, };
