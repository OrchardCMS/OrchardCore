...
public class AzureAISearchSettingsDeploymentStepDriver : DisplayDriver<DeploymentStep, AzureAISearchSettingsDeploymentStep>
{
    ...
    public override IDisplayResult Edit(AzureAISearchSettingsDeploymentStep step) => View("AzureAISearchSettingsDeploymentStep_Fields_Edit", step).Location("Content");
}
