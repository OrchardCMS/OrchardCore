...
internal sealed class IndexingMigrations : DataMigration
{
    ...
    public int Create()
    {
        ...
        ShellScope.AddDeferredTask(async scope =>
        {
            ...
            sqlBuilder.WhereAnd($" ({quotedTypeColumnName} = 'OrchardCore.Search.Lucene.Model.LuceneIndexSettingsDocument, OrchardCore.Search.Lucene' OR {quotedTypeColumnName} = 'OrchardCore.Lucene.Model.LuceneIndexSettingsDocument, OrchardCore.Lucene') ");
            sqlBuilder.Take("1");
