var shortcodesApp;let insertAtCaret=(e,t)=>{if(document.selection)e.focus(),document.selection.createRange().text=t,e.focus();else if(e.selectionStart||"0"===e.selectionStart){let o=e.selectionStart,s=e.selectionEnd,r=e.scrollTop;e.value=e.value.substring(0,o)+t+e.value.substring(s,e.value.length),e.focus(),e.selectionStart=o+t.length,e.selectionEnd=o+t.length,e.scrollTop=r}else e.value+=t,e.focus()},shortcodeWrapperTemplate=`
