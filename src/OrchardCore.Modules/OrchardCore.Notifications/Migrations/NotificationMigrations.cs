...
public class NotificationMigrations : DataMigration
{
    ...
    {
        await SchemaBuilder.CreateMapIndexTableAsync<NotificationIndex>(
            table =>
                table
        ...
        await SchemaBuilder.AlterIndexTableAsync<NotificationIndex>(
            table => table.CreateIndex("IDX_NotificationIndex_DocumentId", "DocumentId", "NotificationId", "UserId", "IsRead", "CreatedAtUtc", "Content"),
            collection: NotificationConstants.NotificationCollection
        );
