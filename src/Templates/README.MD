...
Fire up Visual Studio, open Orchard Core solution file (.sln), select /src folder, right click and select "add --> new project" and create a new ASP.NET Core Web Application : 
