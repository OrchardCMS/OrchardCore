...
```dotnet new install OrchardCore.ProjectTemplates::2.0.1-*```
...
```dotnet add .\MyModule\MyModule.csproj package OrchardCore.Admin --version 2.0.1-*```

!!! note
    To use the development branch of the template add ` --source https://nuget.cloudsmith.io/orchardcore/preview/v3/index.json --version 2.0.1-*`
