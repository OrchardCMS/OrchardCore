...
```xml
<ItemGroup>
  <PackageReference Include="OrchardCore.Application.Cms.Core.Targets" Version="3.0.0" />
</ItemGroup>
```
...
- In the left menu, select __Design__ then __Content Definition__ after that __Content Types__.
