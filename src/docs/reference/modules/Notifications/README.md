...
| `CacheDurationInSeconds`                 | Caches the top unread user notifications for performance optimization, with a default duration of 1800 seconds. Can be adjusted or set to `0` to disable caching. |
