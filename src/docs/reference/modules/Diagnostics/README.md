...
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `HttpError__BadRequest` or `HttpError__400`     | Generates the `400` HTTP error page. You can adjust its appearance by modifying the `HttpError-BadRequest.cshtml` or `HttpError-BadRequest.liquid` views.                                                                         |
| `HttpError__Forbidden` or `HttpError__403`      | Generates the `403` HTTP error page. You can adjust its appearance by modifying the `HttpError-Forbidden.cshtml` or `HttpError-Forbidden.liquid` views.                                                                           |
| `HttpError__NotFound` or `HttpError__404`       | Generates the `404` HTTP error page. You can adjust its appearance by modifying the `HttpError-NotFound.cshtml` or `HttpError-NotFound.liquid` views.                                                                             |
| `HttpError__Unauthorized` or `HttpError__401`   | Generates the `401` HTTP error page. You can adjust its appearance by modifying the `HttpError-Unauthorized.cshtml` or `HttpError-Unauthorized.liquid` views.                                                                     |
| `HttpError__TooManyRequests` or `HttpError__429`| Generates the `429` HTTP error page. You can adjust its appearance by modifying the `HttpError-TooManyRequests.cshtml` or `HttpError-TooManyRequests.liquid` views.                                                                     |
