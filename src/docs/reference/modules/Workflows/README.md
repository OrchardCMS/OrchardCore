...
| `requestForm` | Returns all the value(s) of the form or a specific form field name passed in as an argument. | `requestForm(): Array`<br/>`requestForm(name: String): String` or `Array` |
