...
| `FeatureProfile` | Optional. Name of the selected feature profile if Feature Profiles are used. See the [documentation of the Tenants module](../Tenants/README.md) for details. |
