...
- We suggest you to read the docs about the [GraphQL module](https://docs.orchardcore.net/en/latest/reference/modules/Apis.GraphQL/), to be used for querying content items.
