...
| [JsonPath.NET](https://github.com/gregsdennis/json-everything/tree/master/JsonPath) | A string syntax for selecting and extracting JSON values from within a given JSON value. | 1.0.3 | [MIT](https://github.com/gregsdennis/json-everything/blob/master/LICENSE) |
| [libphonenumber-csharp](https://github.com/twcclegg/libphonenumber-csharp) | .NET library for parsing, formatting, and validating international phone numbers | 8.13.36 | [Apache-2.0](https://github.com/twcclegg/libphonenumber-csharp/blob/main/LICENSE) |
...
| [MailKit](https://github.com/jstedfast/MailKit) | A cross-platform .NET library for IMAP, POP3, and SMTP. | 4.5.0 | [MIT](https://github.com/jstedfast/MailKit/blob/master/LICENSE) |
...
| [Microsoft.Extensions.Http.Resilience](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.Http.Resilience) | Resilience mechanisms for HttpClient built on the Polly framework. | 8.4.0 | [MIT](https://github.com/dotnet/extensions/blob/main/LICENSE) |
| [Microsoft.Identity.Web](https://github.com/AzureAD/microsoft-identity-web) | Helps creating protected web apps and web APIs with Microsoft identity platform and Azure AD B2C. | 2.18.1 | [MIT](https://github.com/AzureAD/microsoft-identity-web/blob/master/LICENSE) |
...
| [MimeKit](https://github.com/jstedfast/MailKit) | A cross-platform .NET library for IMAP, POP3, and SMTP. | 4.5.0 | [MIT](https://github.com/jstedfast/MailKit/blob/master/LICENSE) |
