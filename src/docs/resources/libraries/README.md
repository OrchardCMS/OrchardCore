...
| [Noda Time](https://github.com/nodatime/nodatime) | A better date and time API for .NET. | 3.0.6 | [Apache-2.0](https://github.com/nodatime/nodatime/blob/master/LICENSE.txt) |
...
| [Code Mirror](https://github.com/codemirror/CodeMirror) | In-browser code editor. | 5.62.3 | [MIT](https://github.com/codemirror/CodeMirror/blob/master/LICENSE) |
...
| [Monaco Editor](https://microsoft.github.io/monaco-editor) | Lightweight source code editor | 0.27.0 | [MIT](https://github.com/microsoft/monaco-editor/blob/main/LICENSE.md) |
...
| [Cypress](https://github.com/cypress-io/cypress) | Fast, easy and reliable testing for anything that runs in a browser. | 8.4.0 | [MIT](https://github.com/cypress-io/cypress/blob/develop/LICENSE) |
