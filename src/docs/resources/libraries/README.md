...
| [libphonenumber-csharp](https://github.com/twcclegg/libphonenumber-csharp) | C# port of Google's libphonenumber library. | 8.13.19 | [Apache-2.0](https://github.com/twcclegg/libphonenumber-csharp/blob/main/LICENSE) |
