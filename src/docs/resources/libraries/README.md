...
| [Fluid.Core](https://github.com/sebastienros/fluid) | .NET Liquid template engine. | 2.2.11 | [MIT](https://github.com/sebastienros/fluid/blob/dev/LICENSE) |
...
| [Shortcodes](https://github.com/sebastienros/shortcodes) | Shortcodes processor for .NET. | 1.3.1 | [MIT](https://github.com/sebastienros/shortcodes/blob/dev/LICENSE) |
