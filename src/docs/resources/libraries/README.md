...
| [NJsonSchema](https://github.com/RicoSuter/NJsonSchema) | JSON Schema reader, generator and validator for .NET | 10.6.7 | [MIT](https://github.com/RicoSuter/NJsonSchema/blob/master/LICENSE.md) |
...
| [Cypress](https://github.com/cypress-io/cypress) | Fast, easy and reliable testing for anything that runs in a browser. | 9.4.1 | [MIT](https://github.com/cypress-io/cypress/blob/develop/LICENSE) |
