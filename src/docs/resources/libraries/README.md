...
| [Fluid.Core](https://github.com/sebastienros/fluid) | .NET Liquid template engine. | 2.0.11 | [MIT](https://github.com/sebastienros/fluid/blob/dev/LICENSE) |
...
| [YesSql](https://github.com/sebastienros/yessql) | .NET document database working on any RDBMS. | 3.0.4 | [MIT](https://github.com/sebastienros/yessql/blob/dev/LICENSE) |
...
| Library | Usage | Version | License |
|--- | --- | --- | --- |
| [Bootstrap](https://github.com/twbs/bootstrap) | HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web. | 5.0.1 | [MIT](https://github.com/twbs/bootstrap/blob/main/LICENSE) |
...
| [Cypress](https://github.com/cypress-io/cypress) | Fast, easy and reliable testing for anything that runs in a browser. | 7.3.0 | [MIT](https://github.com/cypress-io/cypress/blob/develop/LICENSE) |
