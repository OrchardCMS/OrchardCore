...
| [Microsoft.Identity.Web](https://github.com/AzureAD/microsoft-identity-web) | Helps creating protected web apps and web APIs with Microsoft identity platform and Azure AD B2C. | 2.18.2 | [MIT](https://github.com/AzureAD/microsoft-identity-web/blob/master/LICENSE) |
