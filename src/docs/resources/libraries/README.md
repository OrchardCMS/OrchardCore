...
| [Azure Identity](https://github.com/Azure/azure-sdk-for-net/blob/master/sdk/identity/Azure.Identity/README.md) | Azure Active Directory token authentication support. | 1.4.1 |[MIT](https://github.com/Azure/azure-sdk-for-net/blob/master/LICENSE.txt) |
...
| [MailKit](https://github.com/jstedfast/MailKit) | A cross-platform .NET library for IMAP, POP3, and SMTP. | 2.14.0 | [MIT](https://github.com/jstedfast/MailKit/blob/master/LICENSE) |
...
| [MimeKit](https://github.com/jstedfast/MailKit) | A cross-platform .NET library for IMAP, POP3, and SMTP. | 2.14.0 | [MIT](https://github.com/jstedfast/MailKit/blob/master/LICENSE) |
...
| [Monaco Editor](https://microsoft.github.io/monaco-editor) | Lightweight source code editor | 0.26.1 | [MIT](https://github.com/microsoft/monaco-editor/blob/main/LICENSE.md) |
...
| [Cypress](https://github.com/cypress-io/cypress) | Fast, easy and reliable testing for anything that runs in a browser. | 8.2.0 | [MIT](https://github.com/cypress-io/cypress/blob/develop/LICENSE) |
