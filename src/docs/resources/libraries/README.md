...
| [HtmlSanitizer](https://github.com/mganss/HtmlSanitizer) | Cleans HTML to avoid XSS attacks. | 7.1.475 | [MIT](https://github.com/mganss/HtmlSanitizer/blob/master/LICENSE.md) |
...
| [MailKit](https://github.com/jstedfast/MailKit) | A cross-platform .NET library for IMAP, POP3, and SMTP. | 3.0.0 | [MIT](https://github.com/jstedfast/MailKit/blob/master/LICENSE) |
...
| [MimeKit](https://github.com/jstedfast/MailKit) | A cross-platform .NET library for IMAP, POP3, and SMTP. | 3.0.0 | [MIT](https://github.com/jstedfast/MailKit/blob/master/LICENSE) |
...
| [NJsonSchema](https://github.com/RicoSuter/NJsonSchema) | JSON Schema reader, generator and validator for .NET | 10.6.6 | [MIT](https://github.com/RicoSuter/NJsonSchema/blob/master/LICENSE.md) |
...
| [Code Mirror](https://github.com/codemirror/CodeMirror) | In-browser code editor. | 5.65.1 | [MIT](https://github.com/codemirror/CodeMirror/blob/master/LICENSE) |
...
| [Monaco Editor](https://microsoft.github.io/monaco-editor) | Lightweight source code editor | 0.31.1 | [MIT](https://github.com/microsoft/monaco-editor/blob/main/LICENSE.md) |
...
| Library | Usage | Version | License |
|--- | --- | --- | --- |
| [EasyMDE](https://github.com/Ionaru/easy-markdown-editor) | A simple, beautiful, and embeddable JavaScript Markdown editor. | 2.16.0 | [MIT](https://github.com/Ionaru/easy-markdown-editor/blob/master/LICENSE) |
