...
|--- | --- | --- | --- |
| [Angle Sharp](https://github.com/AngleSharp/AngleSharp) | Angle brackets parser library. | 1.0.6 |[MIT](https://github.com/AngleSharp/AngleSharp/blob/devel/LICENSE) |
...
| [Microsoft.Identity.Web](https://github.com/AzureAD/microsoft-identity-web) | Helps creating protected web apps and web APIs with Microsoft identity platform and Azure AD B2C. | 2.15.5 | [MIT](https://github.com/AzureAD/microsoft-identity-web/blob/master/LICENSE) |
