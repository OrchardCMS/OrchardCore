...
| [Microsoft.Identity.Web](https://github.com/AzureAD/microsoft-identity-web) | Helps creating protected web apps and web APIs with Microsoft identity platform and Azure AD B2C. | 2.13.1 | [MIT](https://github.com/AzureAD/microsoft-identity-web/blob/master/LICENSE) |
...
| [NLog.Web.AspNetCore](https://github.com/NLog/NLog.Web/tree/master/src/NLog.Web.AspNetCore) | NLog integration for ASP.NET. | 5.3.2 | [BSD-3-Clause](https://github.com/NLog/NLog.Web/blob/master/LICENSE) |
...
| [OpenIddict](https://github.com/openiddict/openiddict-core) | Flexible and versatile OAuth 2.0/OpenID Connect stack for .NET. | 4.6.0 | [Apache-2.0](https://github.com/openiddict/openiddict-core/blob/dev/LICENSE.md)) |
...
| [jQuery](https://github.com/jquery/jquery) | jQuery JavaScript Library. | 3.7.0 | [MIT](https://github.com/jquery/jquery/blob/master/LICENSE.txt) |
...
| Library | Usage | Version | License |
|--- | --- | --- | --- |
| [BenchmarkDotNet](https://github.com/dotnet/BenchmarkDotNet) | Powerful .NET library for benchmarking. | 0.13.6 | [MIT](https://github.com/dotnet/BenchmarkDotNet/blob/master/LICENSE.md) |
...
| [VS Test SDK](https://github.com/microsoft/vstest/) | Visual Studio Test Platform. | 17.6.3 | [MIT](https://github.com/microsoft/vstest/blob/master/LICENSE) |
