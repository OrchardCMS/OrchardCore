...
| [GraphQL](https://github.com/graphql/graphiql) | GraphiQL & GraphQL. | 7.2.2 | [MIT](https://github.com/graphql/graphiql/blob/main/LICENSE) |
...
| [Jint](https://github.com/sebastienros/jint) | Javascript Interpreter for .NET. | 3.0.0-beta-2059 | [MIT](https://github.com/sebastienros/jint/blob/dev/LICENSE) |
...
| [Microsoft.Identity.Web](https://github.com/AzureAD/microsoft-identity-web) | Helps creating protected web apps and web APIs with Microsoft identity platform and Azure AD B2C. | 2.16.1 | [MIT](https://github.com/AzureAD/microsoft-identity-web/blob/master/LICENSE) |
...
| [YesSql](https://github.com/sebastienros/yessql) | .NET document database working on any RDBMS. | 4.0.0 | [MIT](https://github.com/sebastienros/yessql/blob/dev/LICENSE) |
...
| [xUnit](https://github.com/xunit/xunit) | Free, open source, community-focused unit testing tool for the .NET Framework. | 2.6.5 | [MIT](https://github.com/xunit/xunit/blob/main/LICENSE) |
| [xUnit Analyzers](https://github.com/xunit/xunit.analyzers) | Roslyn analyzers for xUnit.net. | 1.9.0 | [MIT](https://github.com/xunit/xunit.analyzers/blob/main/LICENSE) |
