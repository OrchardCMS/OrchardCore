...
Added new localization settings that allow the user to set his/her default culture and time zone.

!!! note
    The newly added settings override the current admin localization culture and time zone settings.
