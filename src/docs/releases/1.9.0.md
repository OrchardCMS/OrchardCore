...
SectionDisplayDriver now uses the appropriate UpdateEditorContext on it's Update methods.
Every driver that inherits from it will require to update their contexts.
