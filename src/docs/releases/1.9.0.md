...
Added new localization settings in the User Localization feature that allow the user to set their default culture and time zone.

!!! note
    The newly added settings override the current admin localization culture and time zone settings if the User Localization feature is enabled.
