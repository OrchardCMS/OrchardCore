...
The class `DeploymentPlanResult` was marked abstract. If you are using it to create custom deployment sources, you'll get a compile time error that requires you to create a custom implementation or use either `FileDeploymentPlanResult` or `MemoryDeploymentPlanResult`.
