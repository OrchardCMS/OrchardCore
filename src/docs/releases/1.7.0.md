                    ...
                    .ManyCondition(
                        (val, query, ctx) =>
                        {
                            ...
                            var filteredQuery = query.Any(
                                (q) => q.With<UserIndex>(i => i.NormalizedUserName is not null && i.NormalizedUserName.Contains(normalizedUserName)),
                                (q) => q.With<UserFullnameIndex>(i =>
                                   (i.FirstName is not null && i.FirstName.Contains(val)) ||
                                   (i.LastName is not null && i.LastName.Contains(val)) ||
                                   (i.MiddleName is not null && i.MiddleName.Contains(val))
                                )
                            );
                        ...
                        (val, query, ctx) =>
                        {
                            ...
                            var filteredQuery = query.All(
                                (q) => q.With<UserIndex>(i => i.NormalizedUserName is null || i.NormalizedUserName.NotContains(normalizedUserName)),
                                (q) => q.With<UserFullnameIndex>(i =>
                                   (i.FirstName is null || i.FirstName.NotContains(val)) &&
                                   (i.LastName is null || i.LastName.NotContains(val)) &&
                                   (i.MiddleName is null || i.MiddleName.NotContains(val))
                                )
                            );
