...
- `ContentTypeBuilding(BuildingContentTypeContext context)`: Triggered during the creation of a content type.
- `ContentTypePartBuilding(ContentTypePartContextBuilding context)`: Triggered while constructing a content type part.
- `ContentPartFieldBuilding(ContentPartFieldContextBuilding context)`: Triggered when building fields within a content part.
- `ContentPartDefinitionBuilding(ContentPartDefinitionContextBuilding context)`: Triggered during the setup of content part definitions.
...
#### System Content Parts and Fields
