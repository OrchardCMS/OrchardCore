...
The new "URL Rewriting" provides you a way to URL rewrites and redirects for incoming requests. For more info visit [this document](../reference/modules/UrlRewriting/README.md)
