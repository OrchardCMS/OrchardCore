...
Additionally, a new settings named `IndexPrefix` was added to the `OrchardCore_Elasticsearch` to allow you to define a global prefix for all index. This is helpful in cases where environment level index is needed.
