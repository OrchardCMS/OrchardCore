...
```
<!-- In the wrapper element we use the GetInputWrapperCssClasses() helper to get the proper classes. -->
<div class="@Orchard.GetInputWrapperCssClasses()" asp-validation-class-for="Title">
...
| Helper | Description |
| --- | --- |
| `Orchard.GetInputWrapperCssClasses()` | gets the css classes for the wrapper element. |
