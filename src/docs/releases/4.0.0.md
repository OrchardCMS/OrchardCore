...
The content management screens are the first to use it: the content items list, the content item creation form and the content item edition form render the `Contents.List`, `Contents.Create` and `Contents.Edit` trails, whose names and data keys are exposed by `OrchardCore.Contents.ContentsBreadcrumbs`. The other admin screens keep their title for now.
