...
- Modules can add or remove columns of a list by implementing `IAdminListColumnProvider`, and themes can override a cell with `AdminListCell-{Column}.cshtml` or `AdminListCell-{ListName}-{Column}.cshtml`.
