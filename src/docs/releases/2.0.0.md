...
A new extension method named `GetSettingsAsync<T>()` has been added to `ISiteService` interface. This method allows you to retrieve specific settings with a single line of code. For example, to get the `LoginSettings`, you can now use:
