...
A lot of configuration classes commonly used by modules can be `sealed`, improving runtime performance. We've applied this [in a pull request](https://github.com/OrchardCMS/OrchardCore/pull/16238). While you don't need to follow this, we recommend you similarly improve your own extensions too.
