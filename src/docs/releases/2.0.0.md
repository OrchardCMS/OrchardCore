...
- **`CacheDurationInSeconds`**: When caching is enabled, the top unread user notifications are cached for performance optimization. By default, this cache lasts for 1800 seconds. You can adjust this value or set it to `0` to disable caching.
