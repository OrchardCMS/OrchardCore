...
- **`CacheDurationInSeconds`**: When caching is enabled, the top unread user notifications are cached for performance optimization. By default, this cache lasts for 3,600 seconds. You can adjust this value or set it to `null` to disable caching.
