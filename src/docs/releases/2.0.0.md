...
In this release, we've enhanced display performance by streamlining the display drivers. To achieve this, the following methods have been marked as obsolete:
