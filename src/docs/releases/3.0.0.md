...
Prior versions of `OrchardCore`, to configure ReCaptchaSettings you had to navigate to admin and Recaptcha Settings to configure the Sitekey and SecretKey.

You'll be able to configure the settings using environment variables with the ReCaptcha Extension method `ConfigureReCaptchaSettings()`.

Supposedly, the appsettings.json properties will apply the Sitekey and SecretKey to the app during initialization.
