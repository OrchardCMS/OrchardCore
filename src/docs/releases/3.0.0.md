...
The `IContentManager.CreateAsync()` now creates the content item without publishing it. If you need to publish the content item during the creation, then you need to pass `VersionOptions.Published` explicitly.
