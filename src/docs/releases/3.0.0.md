...
- `lucene-index-reset` step, which was used to create a Lucene query. Instead, please use the `ResetIndexProfile` step to create a query.
- `lucene-index-rebuild` step, which was used to create a Lucene query. Instead, please use the `RebuildIndexProfile` step to create a query.
