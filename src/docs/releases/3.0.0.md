...
JavaScript global methods received the new `GlobalMethod.AsyncMethod` property and all built-in methods got matching implementation. In most cases this is non-breaking, for example a recipe that contains
