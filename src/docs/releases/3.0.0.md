...
In the past, administrators could approve a user by editing their details and checking the **Confirm Email** box. This process has now been updated. 

To approve a user, follow these steps:

1. Navigate to the **Users List**.
2. Locate the user you wish to approve.
3. Click on the **Actions** menu next to the user.
4. Select the **Approve** option.

This change streamlines the approval process by moving it out of the user edit form, offering a more straightforward approach to user management.

!!! note
    The **Approve** button will only be visible if the user has not yet been approved.
