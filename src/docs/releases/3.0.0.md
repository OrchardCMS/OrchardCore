...
The `IContentManager.CreateAsync()` now is creating the content item and without publishing it. If you need to publish the content item during the creation, then you need to pass `VersionOptions.Published` explicitly.
