...
A new Razor helper method was added to allow you to simplify morphying shapes from within Razer views. You can now use `@DisplayAsAsync(Model, "NewShapeType")` to morph the current Model to a new shape type.
