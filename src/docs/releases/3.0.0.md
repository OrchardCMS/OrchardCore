...
If you are using a custom `MenuItemLink-ContentMenuItem.cshtml` file or `MenuItemLink__ContentMenuItem` template, be sure to include this permission check in your code to respect the new setting. Here is an example of how to implement it using Razor view:
