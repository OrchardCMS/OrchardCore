...
//                apm.ApplicationParts.Add(new MetadataPathsApplicationPart(extensionLibraryService.MetadataPaths));
//            });

//            builder.AddRazorOptions(options =>
//            {
//                var extensionLibraryService = services.BuildServiceProvider().GetService<IExtensionLibraryService>();
//                ((List<MetadataReference>)options.AdditionalCompilationReferences)
//                .AddRange(extensionLibraryService.MetadataReferences());
//            });
//        }
//    }
//}