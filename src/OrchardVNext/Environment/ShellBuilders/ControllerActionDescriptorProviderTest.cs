...
namespace Microsoft.AspNet.Mvc {
    public class ControllerActionDescriptorProviderTest : IActionDescriptorProvider {
        ...
        public ControllerActionDescriptorProviderTest([NotNull] IAssemblyProvider assemblyProvider,
