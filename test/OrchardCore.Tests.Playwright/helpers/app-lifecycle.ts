...
export function copyRecipe(sourceDir: string, appDir: string, recipeFileName: string): void {
...
export function copyMigrationsRecipe(sourceDir: string, appDir: string): void {
    copyRecipe(sourceDir, appDir, 'migrations.recipe.json');
}

export function deleteRecipe(appDir: string, recipeFileName: string): void {
    const destDir = path.join(appDir, 'Recipes');
    const destPath = path.join(destDir, recipeFileName);
