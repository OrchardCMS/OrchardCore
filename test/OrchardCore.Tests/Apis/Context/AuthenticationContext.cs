...
namespace OrchardCore.Tests.Apis.Context
{
    internal class PermissionContextAuthorizationHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        {
            var permissions = (_permissionsContext.AuthorizedPermissions ?? Array.Empty<Permission>()).ToList();
    ...
    {
        public IEnumerable<Permission> AuthorizedPermissions { get; set; } = Array.Empty<Permission>();
