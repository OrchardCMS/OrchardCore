...
namespace OrchardCore.Tests.Modules.OrchardCore.Shortcodes
{
    public class ShareShortcodeTests
    {
        ...
        [InlineData("", "[share url=design.doc]Design[/share]", @"<a href=""design.doc"" download=""design.doc"">Design</a>")]
        [InlineData("", "[share]/docs/testing.xml[/share]", @"<a href=""/docs/testing.xml"" download=""testing.xml"">testing</a>")]
        [InlineData("", "[share url=/customer/support.odt]", @"<a href=""/customer/support.odt"" download=""support.odt"">support</a>")]
        [InlineData("", "[share url=/customer/support.odt tooltip=\"Customer Support\" class=\"big bold\"]", @"<a title=""Customer Support"" class=""big bold"" href=""/customer/support.odt"" download=""support.odt"">support</a>")]
        [InlineData("", "[share url=/customer/support.odt save=\"cs.odt\"]", @"<a href=""/customer/support.odt"" download=""cs.odt"">support</a>")]
