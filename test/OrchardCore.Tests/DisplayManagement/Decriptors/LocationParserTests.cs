...
namespace OrchardCore.Tests.DisplayManagement.Decriptors
{
    public class LocationParserTests
    {
        ...
        [InlineData("/Content:5%Card11", true)]
        ...
        [InlineData("Content:5%Card1%Card1", "Card1")]
        [InlineData("Content:5%Card1%Col1", "Card1")]
        [InlineData("Content:5%Card1#Tab1", "Card1")]
        [InlineData("Content:5%Card1#Tab1%Card1", "Card1")]
        [InlineData("Content:5%Card1#Tab1$Col1", "Card1")]
        [InlineData("Content:5%Card1#Tab1%Card1$Col1", "Card1")]
        [InlineData("Content:5#Tab1%Card1", "Card1")]
        [InlineData("Content:5#Tab1%Card1%Card1", "Card1")]
        [InlineData("Content:5#Tab1%Card1$Col1", "Card1")]
        [InlineData("Content:5#Tab1%Card1%Card1$Col1", "Card1")]
        [InlineData("/Content", null)]
        [InlineData("/Content:5", null)]
        [InlineData("/Content:5#Tab1", null)]
        [InlineData("/Content:5.1#Tab1", null)]
        ...
        [InlineData("/Content:5%Card1%Card1", "Card1")]
        [InlineData("/Content:5%Card1$Col1", "Card1")]
        [InlineData("/Content:5%Card1%Card1$Col1", "Card1")]
        [InlineData("/Content:5%Card1#Tab1", "Card1")]
        [InlineData("/Content:5%Card1#Tab1%Card1", "Card1")]
        [InlineData("/Content:5%Card1#Tab1$Col1", "Card1")]
        [InlineData("/Content:5%Card1#Tab1%Card1$Col1", "Card1")]
        ...
        [InlineData("/Content:5#Tab1%Card1$Col1", "Card1")]
        [InlineData("/Content:5#Tab1%Card1%Card1$Col1", "Card1")]
        public void CardShouldBeParsed(string location, string expectedGroup)
        {
            Assert.Equal(expectedGroup, new PlacementInfo { Location = location }.GetCard());
        }
        ...
        public void ColumnShouldBeParsed(string location, string expectedGroup)
        {
            Assert.Equal(expectedGroup, new PlacementInfo { Location = location }.GetColumn());
        }
    }
}
